...
```json
{
  ...
  "session-id": "b5f6c1c2-1111-2222-3333-444455556666",
  "turn-id": "12345",
...
`"session-id"` contains the UUID of the Codex session that produced the notification; you can use it to correlate multiple turns that belong to the same task.
